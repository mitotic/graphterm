...
with multi-user support in 5-10 minutes:
 ...
 2. If this computer is a pristine Linux/Mac server where you want to
 ...
 3. If you do not already have a server, you should obtain an `AWS <http://aws.amazon.com/>`_ account as
 ...
 11. Use the URL http://server_domain_name to open a new graphtem
